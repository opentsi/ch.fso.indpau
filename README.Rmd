...
[![dataset](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/opentsi/ch.fso.indpau/main/data-raw/shield.json)](https://github.com/opentsi/ch.fso.indpau/actions/workflows/update_data.yaml)
...
ts <- read_open_ts(series = "var.utot.ind.brut",
  remote_archive = "opentsi/ch.fso.indpau",
)
ts202307 <- read_open_ts(series = "var.utot.ind.brut",
  remote_archive = "opentsi/ch.fso.indpau",
  date = "2023-07-01"
)
ts202307$id <- "var.utot.ind.brut.202307"
ts$id <- sprintf("var.utot.ind.brut.202606")
